 ...
 * @author manliqi
 */
@Named(value = "tServiceFulfillmentCheckMB")
@ViewScoped
public class TServiceFulfillmentCheckManagedBean {

    /**
     * Creates a new instance of TServiceFulfillmentCheckManagedBean
     */
    @EJB
    ...
    public TServiceFulfillmentCheckManagedBean() {
    }
    ...
    public void init() {
        ...
        pendingFulfillmentCheckList = quotationManagementSB.retrieveAllTransportationFulfillmentcheckList(companyId);
    ...
    public void passCheck() {
        ...
        systemLogSB.recordSystemLog(userId, "TMS fulfillment check passed");
    }

    public void failCheck() {
        quotationManagementSB.failFulfillmentCheck(requestToView.getQuotationId());
        pendingFulfillmentCheckList.remove(requestToView);
        systemLogSB.recordSystemLog(userId, "TMS fulfillment check failed");
