 ...
 * @author manliqi
 */
@Named(value = "createTransportationRequestMB")
@ViewScoped
public class CreateTransportationRequestManagedBean {

    /**
     * Creates a new instance of CreateTransportationRequestManagedBean
     */
    @EJB
    ...
    public CreateTransportationRequestManagedBean() {
    }
    ...
    public void createTransportationServicePO() {
...
//                Valid delivery date
        ...
        if (canCreateServicePO) {
            boolean result = servicePOSB.createServicePO(contractId, userId, volume, serviceStartDate, serviceEndDate, serviceDeliveryDate, productQuantityPerTEU, productId, null, null);
            if (result) {
                this.clearAllFields();
                ...
                logSB.recordSystemLog(userId, "TMS created a transportation service request");
...
//                fill in all fields necessary for transportation contract
                ...
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "Not a Transportation Service Contract!", "You can only search for a transportation service contract to generate transportation service requests"));
                contract = null;
